...
By the end, you will have a Flue agent running inside GitHub Actions, and you will know how to use local sandbox context, external CLIs, reusable agent definitions, skills, and typed results to build CI workflows.
